...
module.exports = function(app, db) {
	  ...
	  app.post('/expense', (req, res) => {
		    ...
		    if (isNaN(floatValue)) {
		        ...
		        //res.send({ 'error': 'A data error has occurred value.isNaN()!' });
		    ...
		    if (typeof dataError !== 'undefined' && dataError !== null) {
			    //console.log("dataError undefined expression - dataError:" + dataError + "expression evaluation:" + (dataError !== 'undefined'));
	  ...
	  var isDate = function(date) {
		    //console.log("Does \'new Date(" + date + ")\' evalue to an \'Invalid Date\'? : " + (new Date(date) !== "Invalid Date") );
